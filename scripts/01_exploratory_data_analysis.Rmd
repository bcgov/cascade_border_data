...
df_trucks$nbound_rollavg <- 
  rollapply(df_trucks$total_nbound, width = 28, FUN = mean, fill = NA, align='right')

df_trucks$sbound_rollavg <- 
  rollapply(df_trucks$total_sbound, width = 28, FUN = mean, fill = NA, align='right')
...
ggplot(df_trucks, aes(x = ref_date, y = nbound_rollavg)) +
  geom_line()
